declare global {
  const OnsiteDragonNotFoundError: typeof import('../../server/utils/onsite')['OnsiteDragonNotFoundError']
  const OnsiteError: typeof import('../../server/utils/onsite')['OnsiteError']
  const ServerError: typeof import('../../server/utils/ServerError')['ServerError']
  ...
  const checkDragonsMatchGender: typeof import('../../server/utils/onsite')['checkDragonsMatchGender']
  ...
  const dcApiFetch: typeof import('../../server/utils/dcApiFetch')['dcApiFetch']
  ...
  const getDataForPair: typeof import('../../server/utils/onsite')['getDataForPair']
  const getDragonCodesFromHTML: typeof import('../../server/utils/onsite')['getDragonCodesFromHTML']
  ...
  const grabHTML: typeof import('../../server/utils/onsite')['grabHTML']
...
declare global {
  // @ts-ignore
  export type { ServerError, ErrorArray } from '../../server/utils/ServerError'
  import('../../server/utils/ServerError')
  // @ts-ignore
  export type { DragonData, GetDragonsBulkResponse, DragCaveApiResponse } from '../../server/utils/dcApiFetch'
  import('../../server/utils/dcApiFetch')
  // @ts-ignore
  export type { OnsiteError, OnsiteDragonNotFoundError, DragonOnsite, DragonPair } from '../../server/utils/onsite'
  import('../../server/utils/onsite')
  // @ts-ignore
  export type { RequestContext } from '../../server/utils/types'
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from '/home/runner/work/dc-lineage-builder/dc-lineage-builder/node_modules/nuxt/dist/core/runtime/nitro/utils/paths';
